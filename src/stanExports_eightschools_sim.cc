...
#include "stanExports_eightschools_sim.h"

RCPP_MODULE(stan_fit4eightschools_sim_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eightschools_sim")
