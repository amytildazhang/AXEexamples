...
All variance/covariance posterior means, LCO approximations, and MCV ground-truth values are bundled together in the `data` folder. Load them individually using their locations or all together:
