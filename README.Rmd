...
Access by loading the package (`library(AXEexamples)`) and calling the name of the data, e.g. `eight; str(eight)`.

For code to reproduce paper figures, see the "Overview" vignette (`vignettes("overview")`).
